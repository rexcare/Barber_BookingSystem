...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class CompanyInfosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Address,Email,Phone,WorkTimeTemplateInfo,GenerationDate")] CompanyInfo companyInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Address,Email,Phone,WorkTimeTemplateInfo,GenerationDate")] CompanyInfo companyInfo)
        {
