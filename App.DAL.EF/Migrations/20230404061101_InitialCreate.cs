...
namespace App.DAL.EF.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "WorkTimeTemplates",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    StartTime = table.Column<TimeOnly>(type: "time without time zone", nullable: false),
                    StopTime = table.Column<TimeOnly>(type: "time without time zone", nullable: false),
                    StartTime1 = table.Column<TimeOnly>(type: "time without time zone", nullable: true),
                    StopTime1 = table.Column<TimeOnly>(type: "time without time zone", nullable: true),
                    StartTime2 = table.Column<TimeOnly>(type: "time without time zone", nullable: true),
                    StopTime2 = table.Column<TimeOnly>(type: "time without time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkTimeTemplates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkTimeTemplateId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_WorkTimeTemplates_WorkTimeTemplateId",
                        column: x => x.WorkTimeTemplateId,
                        principalTable: "WorkTimeTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReservedTimes_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateStop = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkTimes_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_WorkTimeTemplateId",
                table: "AspNetUsers",
                column: "WorkTimeTemplateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservedTimes_AppUserId",
                table: "ReservedTimes",
                column: "AppUserId");
